              ...
              <ul className="space-y-3 text-neutral-700">
                ...
                <li className="flex items-start">
                  ...
                  <div className="mt-2 flex flex-wrap gap-2 ml-6">
                    <CertificationBadge label="OEKO-TEX" color="green" icon={<Icons.Check className="w-3 h-3" />} />
                    <CertificationBadge label="REACH" color="blue" icon={<Icons.Check className="w-3 h-3" />} />
                    <CertificationBadge label="Prop 65" color="yellow" icon={<Icons.Warning className="w-3 h-3" />} />
                  </div>
                </li>
              </ul>
            </div>
