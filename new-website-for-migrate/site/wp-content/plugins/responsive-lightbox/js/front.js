(function ($) {
  ...
  function initPlugin() {
    ...
    $(".rl-gallery-container").each(function () {
      ...
      else container.removeClass("rl-loading");
    });
    ...
    if (containers.length > 0) {
      ...
      for (var i = 0; i < containers.length; i++) {
        ...
        var galleryScrollType = container
          .find(".rl-pagination-bottom")
          .data("button");
        var galleryButton =
          typeof galleryScrollType !== "undefined" &&
          galleryScrollType === "manually";
        ...
        infArgs[i].gallery.infiniteScroll({
          ...
          button: infArgs[i].galleryButton
            ? '.rl-gallery-container[data-gallery_id="' +
              infArgs[i].galleryId +
              '"] .rl-load-more'
            : false,
          ...
          onInit: function () {
            ...
            if (
              args.container.hasClass("rl-pagination-infinite") &&
              args.galleryButton
            ) {
              // remove loading class
            ...
            this.on("append", function (body, path, items, response) {
              ...
              $.event.trigger({
                ...
                masonry:
                  args.gallery.hasClass("rl-masonry-gallery") ||
                  args.gallery.hasClass("rl-basicmasonry-gallery"),
  ...
  $(document).on("doResponsiveLightbox", function (event) {
    ...
    if (
      typeof event.delayLightbox !== "undefined" &&
      event.delayLightbox === true
    )
      delayLightbox = true;
    ...
    setTimeout(function () {
      ...
      if (args.woocommerce_gallery) {
        ...
        if (
          gallery.find(".woocommerce-product-gallery__trigger").length === 0
        ) {
          gallery.prepend(
            ...
            function (e) {
              ...
              if (script === "lightgallery") {
                if (flex.length) {
                  ...
                  var linkId = flex
                    .find(".flex-active-slide a[data-rel]")
                    .data("lg-id");
                ...
                if (flex.length) {
                  ...
                  Fancybox.fromOpener(
                    '[data-fancybox="' + link.data("fancybox") + '"]',
                    {
                      startIndex: 0,
                    }
                  );
                ...
                else gallery.find("a[data-rel]").first().trigger("click");
              }
            }
          );
        }
  ...
  function initLightbox(event) {
    ...
    switch (script) {
      case "swipebox":
        ...
        $(
          'a[rel*="' + selector + '"], a[data-rel*="' + selector + '"]'
        ).swipebox({
          ...
          afterOpen: function () {
            ...
            observeContentChanges(
              document.getElementById("swipebox-slider"),
              false,
              function () {
                if (imageSource === "") {
                  // get image source
      ...
      case "prettyphoto":
        ...
        $('a[rel*="' + selector + '"], a[data-rel*="' + selector + '"]').each(
          function () {
            var el = $(this);
          ...
          function () {
            ...
            if (typeof attr !== "undefined" && attr !== false) {
              var match = attr.match(
                new RegExp(selector + "\\-(gallery\\-(?:[\\da-z]{1,4}))", "ig")
              );
        ...
        $(
          ...
          afterShowLightbox: function (lightbox) {
            ...
            if (!observerInitialized) {
              ...
              observeContentChanges(
                document.getElementsByClassName("nivo-lightbox-content")[0],
                true,
                function () {
                  if (changeAllowed) {
                    lastImage = content
                      .find(".nivo-lightbox-image img")
                      .attr("src");
        ...
        if (selectors.length > 0) {
          ...
          $(selectors).each(function (i, item) {
            if (typeof event.pagination_type !== "undefined") {
              $('a[data-rel="' + item + '"], a[rel="' + item + '"]').each(
                function () {
        ...
        if (selectors.length > 0) {
          ...
          $(selectors).each(function (i, item) {
            ...
            tos.on("sliding.tos", function (event, number) {
              lastImage = $(
                $(event.target).find(".tos-slider .tos-slide")[number]
              )
                .find("img")
                .attr("src");
      ...
      case "magnific":
        ...
        if (selectors.length > 0) {
          ...
          $(selectors).each(function (i, item) {
            ...
            if (typeof content_type !== "undefined") media_type = content_type;
            ...
            if (args.fixedContentPos === "true") fixedContentPos = true;
            else if (args.fixedContentPos === "false") fixedContentPos = false;

            if (args.fixedBgPos === "true") fixedBgPos = true;
            else if (args.fixedBgPos === "false") fixedBgPos = false;
