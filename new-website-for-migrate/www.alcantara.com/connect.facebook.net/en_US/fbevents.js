        ...
        (function () {
          ...
          function b(b, c, d, e) {
            if (b != null && (b.eventID != null || b.event_id != null)) {
              ...
              f !== null &&
                J(f) === "object" &&
                ("eventID" in f || "event_id" in f
                  ? (f = f.eventID != null ? f.eventID : f.event_id)
                  : a.logUserError({
                      pixelID: e || "",
              ...
              f == null &&
                (c.event_id != null || c.eventID != null) &&
                a.consoleWarn(
                  "eventID is being sent in the 3rd parameter, it should be in the 4th parameter."
                );
              d.containsKey("eid")
                ? f == null || f.length == 0
                  ? a.logUserError({ pixelID: e || "", type: "NO_EVENT_ID" })
                  : d.replaceEntry("eid", f)
                : d.append("eid", f);
            }
          }
          k.exports = b;
          ...
          function C(a) {
            switch (a.type) {
              ...
              case "NONSTANDARD_EVENT":
                d = a.eventName;
                return (
                  "You are sending a non-standard event '".concat(d, "'. ") +
              ...
              case "NEGATIVE_EVENT_PARAM":
                ...
                b = a.eventName;
                return "Parameter '"
                  .concat(e, "' is negative for event '")
                  .concat(b, "'.");
              case "PII_INVALID_TYPE":
                c = a.key_type;
                d = a.key_val;
                return "An invalid "
                  .concat(c, " was specified for '")
                  .concat(
                    d,
          ...
          j.exports = (function (a) {
            ...
            function (a, b, c) {
              ...
              var db =
                ...
                fb = !{ toString: null }.propertyIsEnumerable("toString"),
                gb = [
                  "toString",
                  "toLocaleString",
                  "valueOf",
              ...
              function Yc(a, b) {
                var c =
                  ...
                  d = a.lastIndexOf(b);
                return -1 !== d
                  ? a.substring(0, d) + (c ? "" : a.substring(d + 1))
                  : a;
              }
              function Y(a, b) {
                var c = a.length;
              ...
              function dd(a) {
                  ...
                  var f =
                    ...
                    (function () {
                      if ("/" === a[b]) {
                        ...
                        for (
                          b++;
                          b < a.length && ("/" !== a[b] || "\\" === a[b - 1]);

                        )
                          b++;
                        return (
                          b++, (c += '"'.concat(a.substring(d, b), '"')), !0
                        );
                      }
                    })();
                  return e(), f;
                ...
                function h(c) {
                  if (
                    ...
                    if (Jc(a[b])) for (; b < a.length && Kc(a[b]); ) b++;
                    return e(), !0;
                  }
                  return !1;
                }
                ...
                function y(d) {
                  if (d.isEndQuote(a[b])) {
                    ...
                    return "," === l
                      ? ((b = h),
                        (c = c.substring(0, d)),
                        { result: k(!1, g), shouldContinue: !1 })
                      : Ic(l)
                      ? ((b = h),
                        (c = c.substring(0, d)),
                        { result: k(!0), shouldContinue: !1 })
                      : ((c = c.substring(0, d)),
                        (b = i + 1),
                        {
                          str: ""
                            .concat(f.substring(0, j), "\\")
                            .concat(f.substring(j)),
                          shouldContinue: !0,
                        });
                  }
                  return null;
                    ...
                    '"' === e && "\\" !== a[b - 1]
                      ...
                      : (e >= " " ||
                          (function (a) {
                            throw new Error(
                              "Invalid character "
                                .concat(JSON.stringify(a), " at position ")
                                .concat(b)
                            );
                          })(e),
                        (c += e),
                ...
                function q(e) {
                  ...
                  if (
                    ...
                    g = a.slice(f, b);
                    return (
                      (c += "undefined" === g ? "null" : JSON.stringify(g)),
                      '"' === a[b] && b++,
                      !0
                    );
                  }
                ...
                !(function () {
                  throw new Error(
                    "Unexpected character "
                      .concat(JSON.stringify(a[b]), " at position ")
                      .concat(b)
                  );
                })();
              }
              ...
              var kd = k.each,
                ...
                md = k.FBSet,
                nd = ["og:image"],
                od = [{ property: "image", type: "Product" }],
                    ...
                    if (null != b) {
                      var d = (function (a) {
                        for (var b = 1; b < arguments.length; b++) {
                          var c = null != arguments[b] ? arguments[b] : {};
                          b % 2
                            ? id(Object(c), !0).forEach(function (b) {
                                jd(a, b, c[b]);
                              })
                            : Object.getOwnPropertyDescriptors
                            ? Object.defineProperties(
                            ...
                            : id(Object(c)).forEach(function (b) {
                                Object.defineProperty(
                                  a,
                                  b,
                                  Object.getOwnPropertyDescriptor(c, b)
              ...
              function Rd(a, b, c, d) {
                ("productID" !== c && "sku" !== c) ||
                  ...
                  qd.includes(b.toLowerCase()) &&
                    "description" === c &&
                    (a.description = d),
                  td.includes(b.toLowerCase()) &&
                ...
                var c = {},
                  d = (function (a) {
                    ...
                    a = (function (a) {
                      ...
                      if (!Array.isArray(a))
                        return (
                          (b.price = fe($(a, zd))), (b.currency = $(a, Ad)), b
                        );
                      return 0 === a.length
                        ? b
                        : (kd(a, function (a) {
              ...
              var le = { description: !0, keywords: !0 };
              function me() {
                var a =
                    arguments.length > 0 &&
                    void 0 !== arguments[0] &&
